...
class SocketifyAPI:
    ...
    def _handle_get_current_user(self, res, req):
        async def handle():
            try:
    ...
    def _handle_get_user(self, res, req):
        async def handle():
            try:
    ...
    def _handle_get_conversations(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_create_direct_chat(self, res, req):
    ...
    def _handle_create_group(self, res, req):
        def on_data(res, chunk, is_end):
            if is_end:
                async def handle():
                    try:
    ...
    def _handle_get_messages(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_get_participants(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_get_contacts(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_send_contact_request(self, res, req):
        def on_data(res, chunk, is_end):
            if is_end:
                async def handle():
                    try:
    ...
    def _handle_accept_contact_request(self, res, req):
        def on_data(res, chunk, is_end):
            if is_end:
                async def handle():
                    try:
    ...
    def _handle_decline_contact_request(self, res, req):
        def on_data(res, chunk, is_end):
            if is_end:
                async def handle():
                    try:
    ...
    def _handle_remove_contact(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_block_user(self, res, req):
        def on_data(res, chunk, is_end):
            if is_end:
                async def handle():
                    try:
    ...
    def _handle_unblock_user(self, res, req):
        def on_data(res, chunk, is_end):
            if is_end:
                async def handle():
                    try:
    ...
    def _handle_get_pending_requests(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_get_blocked_users(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_search_users(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_file_upload(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_get_file(self, res, req):
        async def handle():
            try:
    ...
    def _handle_delete_file(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_get_message_history(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_search_messages(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
    ...
    def _handle_get_conversation_stats(self, res, req):
        async def handle():
            try:
                user = await self._verify_session(req)
                if not user:
